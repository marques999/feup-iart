...
frase_int_morrer_sec(N-G,Adj,_,Nac,Cont,Gen,morrer,Temp,SecNum,Adv) --> sint_nom_int(N-G,Adj,autor,Nac,Cont,Gen), verbo(N,morrer,Temp), adverbio(Adv), [do], [seculo], [Sec], {seculo(Sec,SecNum)}, [?].
frase_int_morrer_sec(N-G,Adj,_,Nac,Cont,Gen,morrer,Temp,SecNum,Adv) --> sint_nom_int(N-G,Adj,autor,Nac,Cont,Gen), verbo(N,morrer,Temp), adverbio(Adv), [do], [seculo], [Sec], {seculo(Sec,SecNum)}, [?].
