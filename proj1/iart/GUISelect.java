...
public class GUISelect extends JDialog {
	...
	private String emptyMessage = "Por favor seleccione uma opção primeiro!";
	...
	public GUISelect(Frame parent, String[] valueList) {
		...
		guiList = new JList<String>(valueList);
	...
	private void buttonOkActionPerformed(final ActionEvent evt) {
		...
		if (selectedValue == null) {
			JOptionPane.showMessageDialog(this, emptyMessage, "Bibliogenie", JOptionPane.WARNING_MESSAGE);
		}
		else {
			dialogResult = selectedValue;
			dispose();
