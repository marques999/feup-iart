...
public class GUIMain extends javax.swing.JFrame {
	...
	private final String msgHistoryEmpty = "N�o adicionou nenhuma pesquisa ao hist�rico.";
	...
	private void initComponents() {
		...
		listExamples.setModel(new AbstractListModel<String>() {
			...
			final String[] strings = {
				...
				"Quais s�o os livros mais conhecidos de Fernando Pessoa?",
				"Quem s�o os escritores africanos?",
				"E portugueses?",
				"Quais os escritores portugueses e espanh�is do s�culo XV?",
				"Quantos livros de escritores africanos existem ap�s o s�culo XVI?",
				"E qual � o mais recente?",
		...
		guiTabs.addTab("Hist�rico", tabHistory);
		...
		guiTabs.addTab("Informa��es", tabInformation);
